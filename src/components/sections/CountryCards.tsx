...
import { ArrowRight, Clock, FileCheck, Play } from "lucide-react";
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {countries.map((country, i) => (
            <motion.article
              ...
              className="group relative overflow-hidden rounded-2xl border border-border/60 bg-surface shadow-lg transition-shadow hover:shadow-2xl hover:shadow-coral/10"
            >
              {/* Media */}
              <div className="relative aspect-[4/3] overflow-hidden">
                {country.video && hoveredId === country.id ? (
                  <video
                    autoPlay
                    muted
                    loop
                ...
                {country.video && (
                  <div className="absolute right-3 top-3 flex h-8 w-8 items-center justify-center rounded-full bg-white/20 backdrop-blur-sm transition-opacity group-hover:opacity-0">
              ...
              <div className="p-4">
                ...
                <Link
                  ...
                  className="group/btn flex w-full items-center justify-center gap-2 rounded-xl bg-coral px-4 py-2.5 text-sm font-semibold text-white shadow-md shadow-coral/25 transition-all hover:bg-coral-dark hover:shadow-lg hover:shadow-coral/35"
                >
