  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-navy/95 via-navy/80 to-navy/60 dark:from-navy-dark/95 dark:via-navy-dark/85 dark:to-navy-dark/70" />
        ...
        >
          <div className="relative aspect-square max-w-lg mx-auto">
            ...
            <motion.div
              ...
              className="absolute -left-4 top-8 rounded-2xl border border-white/20 bg-white/10 p-4 backdrop-blur-md"
            >
            ...
            <motion.div
              ...
              className="absolute -right-4 bottom-12 rounded-2xl border border-white/20 bg-white/10 p-4 backdrop-blur-md"
            >
